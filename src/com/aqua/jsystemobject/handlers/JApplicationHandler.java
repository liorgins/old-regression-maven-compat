...
//		DebugLogFile.writeToDebug("starting runner");
		...
		String runnerName = TestRunner.class.getName();
		ClassReference classReference = new ClassReference(runnerName);
		try{
			classReference.startApplication();
		}catch (Throwable mythrow) {
			String error = mythrow.getMessage();
			System.out.println(error);
			mythrow.printStackTrace();
			System.out.println(mythrow.getClass().getName());
		}
